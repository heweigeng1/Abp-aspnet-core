...
using WxOpenApi.Dtos;
using WxOpenApi.Utils;

namespace WxOpenApi.Controllers
{
    public class AppPayController : AbpController
    {
        /// <summary>
        /// 统一下单
        /// </summary>
        /// <param name="input">下单的明细.根据平台的业务修改model</param>
        /// <returns></returns>
        public ActionResult Paying(PayingInput input)
        {
            #region 统一下单map
            ...
            //string xml = map.SortedDictionaryToXml();
